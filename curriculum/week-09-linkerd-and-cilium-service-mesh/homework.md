...
When you've finished all six, push your repo and make sure the `mesh-bakeoff` [mini-project](./mini-project/README.md) is in the same workspace — the ADR is the template for your Week 12 midterm essay. Then take the [quiz](./quiz.md) with your notes closed. This closes Phase 2's service-mesh arc; Week 10 turns to eventing.
