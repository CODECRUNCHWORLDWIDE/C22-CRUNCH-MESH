...
When you've finished all six, push your repo and make sure the `cart-multiregion` [mini-project](./07-mini-project/00-overview.md) is in the same workspace — Week 20 makes this cart genuinely active-active with a CRDT, and Week 22's gameday runs a region-failover drill on this exact topology. Then take the [quiz](./05-quiz.md) with your notes closed.
