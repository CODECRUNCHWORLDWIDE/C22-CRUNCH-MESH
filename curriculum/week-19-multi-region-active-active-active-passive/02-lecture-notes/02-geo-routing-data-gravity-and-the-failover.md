...
Next: the exercises put a two-region topology, replication, geo-routing, and a measured failover on your cart/inventory stack. Continue to [the exercises](../03-exercises/00-overview.md).
