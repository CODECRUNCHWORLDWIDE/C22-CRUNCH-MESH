...
Next: the exercises put all of this on real brokers — JetStream and Pulsar stood up, a Postgres outbox relay in Go, and an idempotent consumer chaos-tested to zero double-charges. Continue to [the exercises](../03-exercises/00-overview.md).
