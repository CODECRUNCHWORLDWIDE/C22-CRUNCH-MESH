...
When you've finished all six, push your repo and make sure the `idempotent-checkout` [mini-project](./07-mini-project/00-overview.md) is in the same workspace — Week 12 builds the orchestrated saga on top of this idempotency foundation. Then take the [quiz](./05-quiz.md) with your notes closed.
