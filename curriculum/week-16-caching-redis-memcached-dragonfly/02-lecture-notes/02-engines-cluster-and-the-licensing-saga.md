...
Next: the exercises put all of this on your cart topology — look-aside with coalescing, a stampede you induce and fix, and the cluster-slot mechanics. Continue to [the exercises](../03-exercises/00-overview.md).
