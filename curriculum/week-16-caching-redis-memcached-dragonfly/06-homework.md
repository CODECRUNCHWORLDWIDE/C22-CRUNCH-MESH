...
When you've finished all six, push your repo and make sure the `cart-cache` [mini-project](./07-mini-project/00-overview.md) is in the same workspace — Week 17 instruments this cache end-to-end and Week 18 wires its failure into the reliability story. Then take the [quiz](./05-quiz.md) with your notes closed.
