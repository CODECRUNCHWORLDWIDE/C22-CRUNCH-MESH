...
| [resources.md](./resources.md) | The Redis/Valkey/Dragonfly docs, the patterns papers, the licensing-saga references |
| [lecture-notes/01-cache-patterns-invalidation-and-the-stampede.md](./lecture-notes/01-cache-patterns-invalidation-and-the-stampede.md) | The four patterns, invalidation strategies, and stampede protection (coalescing + XFetch) |
| [lecture-notes/02-engines-cluster-and-the-licensing-saga.md](./lecture-notes/02-engines-cluster-and-the-licensing-saga.md) | Redis vs Memcached vs Dragonfly, Redis Cluster hash slots, topology, and the licensing change |
| [exercises/README.md](./exercises/README.md) | Index of the three exercises |
| [exercises/exercise-01-look-aside-and-coalescing.md](./exercises/exercise-01-look-aside-and-coalescing.md) | Add look-aside caching to the cart read path with single-flight request coalescing |
| [exercises/exercise-02-stampede-cache-aside.py](./exercises/exercise-02-stampede-cache-aside.py) | A runnable cache-aside implementation with single-flight + probabilistic early expiration |
| [exercises/exercise-03-cluster-hash-slots.go](./exercises/exercise-03-cluster-hash-slots.go) | Compute Redis Cluster slots (CRC16) and demonstrate hash tags forcing keys onto one slot |
| [challenges/README.md](./challenges/README.md) | Index of the weekly challenge |
| [challenges/challenge-01-the-stale-cart-that-wouldnt-die.md](./challenges/challenge-01-the-stale-cart-that-wouldnt-die.md) | Diagnose a stale-read bug caused by a write path that updates the DB but not the cache |
| [quiz.md](./quiz.md) | 13 questions with a hidden answer key |
| [homework.md](./homework.md) | Six problems including the Redis-vs-Dragonfly benchmark memo |
| [mini-project/README.md](./mini-project/README.md) | `cart-cache`: a hardened look-aside cache with stampede protection, CDC invalidation, and a Dragonfly benchmark |
