...
When you've finished all six, push your repo and make sure the `cart-edge` [mini-project](./mini-project/README.md) is in the same workspace — Week 8 sits the Istio mesh behind exactly this edge. Then take the [quiz](./quiz.md) with your notes closed.
