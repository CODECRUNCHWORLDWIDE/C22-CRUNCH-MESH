...
| [resources.md](./resources.md) | The Envoy docs, the CNCF gateway landscape, the talks worth your time |
| [lecture-notes/01-envoy-architecture-and-the-edge.md](./lecture-notes/01-envoy-architecture-and-the-edge.md) | Gateway vs mesh, Envoy listeners/filters/clusters, xDS, the threading model |
| [lecture-notes/02-resilience-bffs-and-the-browser.md](./lecture-notes/02-resilience-bffs-and-the-browser.md) | Timeouts, retries, outlier detection, circuit breakers, the BFF pattern, gRPC-Web vs Connect, rate limiting |
| [exercises/README.md](./exercises/README.md) | Index of the three exercises |
| [exercises/exercise-01-envoy-ingress.md](./exercises/exercise-01-envoy-ingress.md) | Stand up Envoy as an ingress in front of `cart` and `inventory`; verify the proxy hop end-to-end |
| [exercises/exercise-02-resilience-policy.yaml](./exercises/exercise-02-resilience-policy.yaml) | A complete Envoy config with per-route retries+budget, timeouts, outlier detection, and a circuit breaker — runnable |
| [exercises/exercise-03-mobile-bff.go](./exercises/exercise-03-mobile-bff.go) | A Go mobile BFF that fans out to `cart` and `inventory` over gRPC and returns one tailored response |
| [challenges/README.md](./challenges/README.md) | Index of the weekly challenge |
| [challenges/challenge-01-tame-the-retry-storm.md](./challenges/challenge-01-tame-the-retry-storm.md) | Diagnose and stop a retry-amplified outage on a live proxy chain |
| [quiz.md](./quiz.md) | 13 questions with a hidden answer key |
| [homework.md](./homework.md) | Six problems including the gateway-vs-mesh decision memo |
| [mini-project/README.md](./mini-project/README.md) | The `cart-edge` gateway: Envoy + a Go BFF + a global rate limiter, fully audited |
