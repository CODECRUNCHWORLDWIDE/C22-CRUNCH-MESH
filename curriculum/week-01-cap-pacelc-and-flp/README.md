...
| [resources.md](./resources.md) | The original papers, the canonical chapters, and the talks worth your time |
| [lecture-notes/01-cap-and-the-consistency-lattice.md](./lecture-notes/01-cap-and-the-consistency-lattice.md) | CAP formally, the four consistency models, and why "CA" is a category error |
| [lecture-notes/02-pacelc-flp-safety-liveness.md](./lecture-notes/02-pacelc-flp-safety-liveness.md) | PACELC, the FLP impossibility proof, the escape hatches, and safety vs liveness |
| [exercises/README.md](./exercises/README.md) | Index of the three exercises |
| [exercises/exercise-01-classify-the-systems.md](./exercises/exercise-01-classify-the-systems.md) | Place ten real systems on the consistency lattice and the PACELC grid, with justification |
| [exercises/exercise-02-partitioned-register.go](./exercises/exercise-02-partitioned-register.go) | A two-node register with a simulated partition; switch it between CP and AP and observe the difference |
| [exercises/exercise-03-linearizability-checker.go](./exercises/exercise-03-linearizability-checker.go) | A history checker that decides whether a recorded execution is linearizable |
| [challenges/README.md](./challenges/README.md) | Index of the weekly challenge |
| [challenges/challenge-01-audit-a-real-system.md](./challenges/challenge-01-audit-a-real-system.md) | Audit a real system's consistency claims against its actual guarantees and write the verdict |
| [quiz.md](./quiz.md) | 13 questions with a hidden answer key |
| [homework.md](./homework.md) | Six problems including the consistency-audit memo |
| [mini-project/README.md](./mini-project/README.md) | The instrumented two-node register that experimentally exhibits all three CAP regimes |
