...
Next: the exercises put this on real systems and in real code — you classify ten databases, build a two-node register that exhibits CP and AP experimentally, and write a checker that decides whether a recorded history was linearizable. Continue to [the exercises](../03-exercises/00-overview.md).
