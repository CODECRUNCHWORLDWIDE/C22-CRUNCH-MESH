...
When you've finished all six, push your repo and make sure the `orders-at-scale` [mini-project](./07-mini-project/00-overview.md) is in the same workspace — Week 14 streams that exact `orders` table via Debezium. Then take the [quiz](./05-quiz.md) with your notes closed.
