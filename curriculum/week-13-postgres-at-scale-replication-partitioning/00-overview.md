...
| [resources.md](./01-resources.md) | The Postgres docs, replication and partitioning chapters, pgBouncer and Citus docs, and the talks worth your time |
| [lecture-notes/01-replication-physical-and-logical.md](./02-lecture-notes/01-replication-physical-and-logical.md) | The WAL, streaming physical replication, slots, failover, and logical replication |
| [lecture-notes/02-partitioning-bloat-pooling-and-sharding.md](./02-lecture-notes/02-partitioning-bloat-pooling-and-sharding.md) | Declarative partitioning, MVCC/HOT/bloat, `pg_stat_statements`, pgBouncer, and the Citus/Cockroach decision |
| [exercises/README.md](./03-exercises/00-overview.md) | Index of the three exercises |
| [exercises/exercise-01-streaming-replica.md](./03-exercises/exercise-01-streaming-replica.md) | Build a primary + streaming physical replica, measure lag, and promote the replica |
| [exercises/exercise-02-partition-orders.sql](./03-exercises/exercise-02-partition-orders.sql) | Convert a flat `orders` table to monthly `RANGE` partitions online, with pruning proof |
| [exercises/exercise-03-bloat-and-statements.py](./03-exercises/exercise-03-bloat-and-statements.py) | Generate bloat, watch autovacuum, and rank queries by total time via `pg_stat_statements` |
| [challenges/README.md](./04-challenges/00-overview.md) | Index of the weekly challenge |
| [challenges/challenge-01-diagnose-a-slow-storage-tier.md](./04-challenges/challenge-01-diagnose-a-slow-storage-tier.md) | Diagnose three planted storage-tier faults on a live instance and prescribe the fix |
| [quiz.md](./05-quiz.md) | 13 questions with a hidden answer key |
| [homework.md](./06-homework.md) | Six problems including the headline replication-and-partitioning decision memo |
| [mini-project/README.md](./07-mini-project/00-overview.md) | The `orders-at-scale` benchmark harness: 50M rows, before/after partitioning, defensible report |
