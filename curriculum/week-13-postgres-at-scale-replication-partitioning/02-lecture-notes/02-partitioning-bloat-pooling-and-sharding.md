...
Next: the exercises put this on a real instance — a streaming replica, an online partition conversion, and a bloat-and-statements investigation. Continue to [the exercises](../03-exercises/00-overview.md).
