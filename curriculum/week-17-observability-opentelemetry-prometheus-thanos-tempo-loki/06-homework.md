...
When you've finished all six, push your repo and make sure the `cart-observed` [mini-project](./07-mini-project/00-overview.md) is in the same workspace — Week 18 defines SLIs and error budgets as PromQL over these exact metrics. Then take the [quiz](./05-quiz.md) with your notes closed.
