...
| [resources.md](./resources.md) | The OpenTelemetry, Prometheus/Thanos, Tempo, Loki, and Grafana docs worth your time |
| [lecture-notes/01-opentelemetry-and-context-propagation.md](./lecture-notes/01-opentelemetry-and-context-propagation.md) | The three signals, the OTel SDK + Collector, semantic conventions, and context propagation across HTTP/gRPC/Kafka |
| [lecture-notes/02-prometheus-thanos-tempo-loki-and-the-correlated-pane.md](./lecture-notes/02-prometheus-thanos-tempo-loki-and-the-correlated-pane.md) | Prometheus + Thanos, histograms/exemplars/PromQL, Tempo, Loki, the trace-to-log jump, and the costly defaults |
| [exercises/README.md](./exercises/README.md) | Index of the three exercises |
| [exercises/exercise-01-otel-collector-and-the-pipeline.md](./exercises/exercise-01-otel-collector-and-the-pipeline.md) | Stand up the OTel Collector and route traces/metrics/logs to Tempo/Prometheus/Loki — the pipeline, end to end |
| [exercises/exercise-02-thanos-and-promql.yaml](./exercises/exercise-02-thanos-and-promql.yaml) | A complete Prometheus + Thanos deployment (Sidecar/Store/Query/Compactor) with the PromQL RED queries to run against it |
| [exercises/exercise-03-trace-context-across-kafka.py](./exercises/exercise-03-trace-context-across-kafka.py) | Propagate `traceparent` through Kafka message headers and prove one trace survives the producer→consumer boundary |
| [challenges/README.md](./challenges/README.md) | Index of the weekly challenge |
| [challenges/challenge-01-the-trace-that-stops-at-kafka.md](./challenges/challenge-01-the-trace-that-stops-at-kafka.md) | Diagnose a trace that mysteriously ends at the producer, from the outside, and fix the context propagation |
| [quiz.md](./quiz.md) | 13 questions with a hidden answer key |
| [homework.md](./homework.md) | Six problems including the RED-dashboard-with-exemplars build and the cardinality-budget memo |
| [mini-project/README.md](./mini-project/README.md) | `cart-observed`: the full three-signal stack on the cart topology, with exemplar-linked RED dashboards and a trace that survives Kafka |
