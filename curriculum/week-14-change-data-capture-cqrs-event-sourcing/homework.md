...
When you've finished all six, push your repo and make sure the `orders-cdc` [mini-project](./mini-project/README.md) is in the same workspace — Week 15 routes that same change stream into Iceberg. Then take the [quiz](./quiz.md) with your notes closed.
