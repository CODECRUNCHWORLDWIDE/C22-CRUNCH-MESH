...
Next: the exercises put this in your hands — trace a Raft election, implement vector clocks and detect concurrency, and reproduce-then-fix the fencing bug. Continue to [the exercises](../03-exercises/00-overview.md).
