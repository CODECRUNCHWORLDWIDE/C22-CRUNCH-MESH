...
When you've finished all six, push your repo and make sure the `raft-register` [mini-project](./07-mini-project/00-overview.md) is in the same workspace — Week 3 pairs its CP path against the AP path of CRDTs. Then take the [quiz](./05-quiz.md) with your notes closed.
