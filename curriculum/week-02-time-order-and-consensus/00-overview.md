...
| [resources.md](./01-resources.md) | Lamport 1978, the Raft paper and visualization, Paxos Made Simple, and the DDIA chapters |
| [lecture-notes/01-time-clocks-and-logical-order.md](./02-lecture-notes/01-time-clocks-and-logical-order.md) | Why wall clocks lie, happens-before, Lamport timestamps, and vector clocks |
| [lecture-notes/02-consensus-raft-paxos-leases.md](./02-lecture-notes/02-consensus-raft-paxos-leases.md) | Raft deeply, Paxos in overview, and leases + fencing tokens |
| [exercises/README.md](./03-exercises/00-overview.md) | Index of the three exercises |
| [exercises/exercise-01-trace-a-raft-election.md](./03-exercises/exercise-01-trace-a-raft-election.md) | Trace a Raft election and a log-replication round by hand, then verify against the visualization |
| [exercises/exercise-02-vector-clocks.py](./03-exercises/exercise-02-vector-clocks.py) | Implement Lamport and vector clocks; detect concurrency on a recorded message trace |
| [exercises/exercise-03-fencing-tokens.py](./03-exercises/exercise-03-fencing-tokens.py) | Reproduce the lease-without-fencing bug, then fix it with a fencing token the storage checks |
| [challenges/README.md](./04-challenges/00-overview.md) | Index of the weekly challenge |
| [challenges/challenge-01-operate-an-etcd-cluster.md](./04-challenges/challenge-01-operate-an-etcd-cluster.md) | Stand up 3-node etcd on Kind, force elections by killing the leader, and document the failover |
| [quiz.md](./05-quiz.md) | 14 questions with a hidden answer key |
| [homework.md](./06-homework.md) | Six problems including the fencing-token postmortem |
| [mini-project/README.md](./07-mini-project/00-overview.md) | Graft a Raft replicated log onto last week's register and pass a small linearizability test |
