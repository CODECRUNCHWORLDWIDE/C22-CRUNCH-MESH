...
Next: the exercises put all of this on your cart topology — the SLO + burn-rate alerts, the circuit breaker around payment, and KEDA on Kafka lag. Continue to [the exercises](../03-exercises/00-overview.md).
