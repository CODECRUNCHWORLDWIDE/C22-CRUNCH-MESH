...
When you've finished all six, push your repo and make sure the `cart-reliable` [mini-project](./07-mini-project/00-overview.md) is in the same workspace — Phase 4 (Week 19's region failover, Week 22's gameday) stress-tests exactly these SLOs and patterns. Then take the [quiz](./05-quiz.md) with your notes closed.
