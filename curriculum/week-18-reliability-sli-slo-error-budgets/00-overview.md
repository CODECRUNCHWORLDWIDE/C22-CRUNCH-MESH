...
| [resources.md](./01-resources.md) | The Google SRE books, the resilience-pattern docs, the USL/Little's-law references |
| [lecture-notes/01-sli-slo-error-budgets-and-burn-rate.md](./02-lecture-notes/01-sli-slo-error-budgets-and-burn-rate.md) | SLIs, SLOs, error budgets as a resource, and multi-window multi-burn-rate alerting derived from first principles |
| [lecture-notes/02-resilience-patterns-autoscaling-and-the-saturation-point.md](./02-lecture-notes/02-resilience-patterns-autoscaling-and-the-saturation-point.md) | Circuit breakers, bulkheads, retries with jitter, backpressure, load shedding, HPA/KEDA, USL/Little's law, tail latency |
| [exercises/README.md](./03-exercises/00-overview.md) | Index of the three exercises |
| [exercises/exercise-01-slo-and-burn-rate.md](./03-exercises/exercise-01-slo-and-burn-rate.md) | Define three SLIs/SLOs for cart, compute the error budget, and write the multi-window burn-rate alert rules |
| [exercises/exercise-02-circuit-breaker.go](./03-exercises/exercise-02-circuit-breaker.go) | A complete circuit breaker (with timeout + jittered retry) around the payment dependency, with a load test that opens and recovers it |
| [exercises/exercise-03-keda-autoscale-on-lag.yaml](./03-exercises/exercise-03-keda-autoscale-on-lag.yaml) | A complete KEDA ScaledObject autoscaling the Kafka consumer on lag, plus the HPA comparison |
| [challenges/README.md](./04-challenges/00-overview.md) | Index of the weekly challenge |
| [challenges/challenge-01-the-retry-storm-that-took-down-payment.md](./04-challenges/challenge-01-the-retry-storm-that-took-down-payment.md) | Diagnose a retry storm where un-jittered retries + no circuit breaker turned a blip into a full outage, and fix it |
| [quiz.md](./05-quiz.md) | 13 questions with a hidden answer key |
| [homework.md](./06-homework.md) | Six problems including the error-budget-policy memo and the saturation-point measurement |
| [mini-project/README.md](./07-mini-project/00-overview.md) | `cart-reliable`: SLOs + burn-rate alerts + the resilience patterns + KEDA + a measured saturation point on the cart topology |
