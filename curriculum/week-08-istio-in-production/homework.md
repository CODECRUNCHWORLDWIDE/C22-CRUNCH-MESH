...
When you've finished all six, push your repo and make sure the `cart-mesh` [mini-project](./mini-project/README.md) is in the same workspace — Week 9 reinstalls this topology on Linkerd and Cilium and measures against your baseline. Then take the [quiz](./quiz.md) with your notes closed.
