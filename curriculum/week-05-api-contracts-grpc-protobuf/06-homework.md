...
When you've finished all six, push your repo and make sure the gRPC [mini-project](./07-mini-project/00-overview.md) is in the same workspace — Week 6 hardens it into production. Then take the [quiz](./05-quiz.md) with your notes closed.
