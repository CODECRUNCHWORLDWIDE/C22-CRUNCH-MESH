...
Next: the exercises. You'll author the `catalog.v1` contract, generate Go and Python stubs, build a Go server and a Python client that interoperate, and exercise it all with `grpcurl`. Continue to [the exercises](../03-exercises/00-overview.md).
