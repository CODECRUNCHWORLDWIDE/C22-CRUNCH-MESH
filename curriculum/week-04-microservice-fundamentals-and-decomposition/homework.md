...
When you've finished all six, push your repo and make sure the `marketplace-seam` [mini-project](./mini-project/README.md) is in the same workspace — Week 5 turns its HTTP boundary into a typed gRPC contract. Then take the [quiz](./quiz.md) with your notes closed.
