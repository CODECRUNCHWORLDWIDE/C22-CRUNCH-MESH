...
| [resources.md](./01-resources.md) | Evans, Newman, Vernon, the Conway's-law sources, and the talks worth your time |
| [lecture-notes/01-bounded-contexts-and-conways-law.md](./02-lecture-notes/01-bounded-contexts-and-conways-law.md) | Bounded contexts, the ubiquitous language, context maps, Conway's law, and the inverse maneuver |
| [lecture-notes/02-decomposition-heuristics-and-anti-patterns.md](./02-lecture-notes/02-decomposition-heuristics-and-anti-patterns.md) | The decomposition heuristics, the four anti-patterns, and the decomposition memo |
| [exercises/README.md](./03-exercises/00-overview.md) | Index of the three exercises |
| [exercises/exercise-01-draw-the-context-map.md](./03-exercises/exercise-01-draw-the-context-map.md) | Read a monolith description and produce a context map with named contexts, owners, and relationships |
| [exercises/exercise-02-decompose-the-monolith.py](./03-exercises/exercise-02-decompose-the-monolith.py) | A runnable analyzer that scores a proposed topology against the decomposition heuristics |
| [exercises/exercise-03-distributed-monolith-smell.go](./03-exercises/exercise-03-distributed-monolith-smell.go) | A Go tool that detects synchronous-call-chain and shared-database smells in a topology spec |
| [challenges/README.md](./04-challenges/00-overview.md) | Index of the weekly challenge |
| [challenges/challenge-01-decompose-and-defend.md](./04-challenges/challenge-01-decompose-and-defend.md) | Decompose a 40 kLOC monolith and defend the topology with three rejected alternatives |
| [quiz.md](./05-quiz.md) | 13 questions with a hidden answer key |
| [homework.md](./06-homework.md) | Six problems including the headline decomposition memo |
| [mini-project/README.md](./07-mini-project/00-overview.md) | Scaffold the capstone `cart` + `catalog` seam as two independently deployable services |
