...
When you've finished all six, push your repo and make sure the `cart-crdt` [mini-project](./mini-project/README.md) is in the same workspace — it *is* the capstone's cart-service, and Week 22's gameday runs a convergence-across-a-partition demo on it. Then take the [quiz](./quiz.md) with your notes closed.
