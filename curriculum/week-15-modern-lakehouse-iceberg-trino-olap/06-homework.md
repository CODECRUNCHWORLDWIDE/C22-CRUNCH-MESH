...
When you've finished all six, push your repo and make sure the `orders-lakehouse` [mini-project](./07-mini-project/00-overview.md) is in the same workspace. This closes Phase 3's data arc — Postgres at scale (13), the change stream (14), the lakehouse (15). Then take the [quiz](./05-quiz.md) with your notes closed.
