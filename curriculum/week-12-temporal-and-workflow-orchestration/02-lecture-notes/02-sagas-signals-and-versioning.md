...
Next: the exercises put all of this on a running Temporal — a checkout saga with compensation, a signal-driven cancel, and a worker-crash drill proving zero state loss. Continue to [the exercises](../03-exercises/00-overview.md).
