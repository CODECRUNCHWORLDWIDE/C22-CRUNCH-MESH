...
When you've finished all six, push your repo, make sure the `checkout-orchestrator` [mini-project](./07-mini-project/00-overview.md) is in the same workspace, and **start your midterm architecture-review essay** — it's due at the end of this week and Phase 2 is now complete. Then take the [quiz](./05-quiz.md) with your notes closed.
