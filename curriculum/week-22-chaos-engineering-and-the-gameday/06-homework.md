...
When you've finished all six, push your repo and make sure the `marketplace-gameday` [mini-project](./07-mini-project/00-overview.md) is in the same workspace — Week 24's capstone reuses both drills and their postmortems. Then take the [quiz](./05-quiz.md) with your notes closed.
