...
| [resources.md](./resources.md) | The Chaos Mesh / Litmus docs, the principles, the postmortem corpus worth reading |
| [lecture-notes/01-chaos-engineering-principles-and-the-experiment.md](./lecture-notes/01-chaos-engineering-principles-and-the-experiment.md) | The four principles, the hypothesis-first experiment, Chaos Mesh architecture, the six fault types |
| [lecture-notes/02-the-gameday-and-the-blameless-postmortem.md](./lecture-notes/02-the-gameday-and-the-blameless-postmortem.md) | The gameday runbook and roles, the broker-loss/exactly-once drill, the blameless postmortem, the five-whys debate |
| [exercises/README.md](./exercises/README.md) | Index of the three exercises |
| [exercises/exercise-01-install-and-first-experiment.md](./exercises/exercise-01-install-and-first-experiment.md) | Install Chaos Mesh, run a hypothesis-driven `PodChaos`, watch steady state hold (or not) |
| [exercises/exercise-02-six-experiments.yaml](./exercises/exercise-02-six-experiments.yaml) | The six canonical experiments as applyable CRDs, each scoped and bounded |
| [exercises/exercise-03-broker-loss-eos-probe.py](./exercises/exercise-03-broker-loss-eos-probe.py) | Kill a Kafka broker mid-traffic; prove the exactly-once consumer did not double-process |
| [challenges/README.md](./challenges/README.md) | Index of the weekly challenge |
| [challenges/challenge-01-the-gameday-that-found-the-bug.md](./challenges/challenge-01-the-gameday-that-found-the-bug.md) | Run a gameday that surfaces a real latent bug, diagnose it live, write the postmortem |
| [quiz.md](./quiz.md) | 13 questions with a hidden answer key |
| [homework.md](./homework.md) | Six problems including the publishable blameless postmortem |
| [mini-project/README.md](./mini-project/README.md) | `marketplace-gameday`: the full gameday harness — six experiments, a runbook, a live drill, and postmortems |
