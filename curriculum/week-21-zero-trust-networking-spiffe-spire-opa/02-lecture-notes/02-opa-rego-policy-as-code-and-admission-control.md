...
Next: the exercises put SPIRE, a SPIFFE-keyed Rego policy, and a deliberate-violation probe on your cart topology. Continue to [the exercises](../03-exercises/00-overview.md).
