...
When you've finished all six, push your repo and make sure the `cart-zerotrust` [mini-project](./mini-project/README.md) is in the same workspace — it *is* the capstone's security layer, and Week 22's gameday includes certificate-expiry as a named failure mode. Then take the [quiz](./quiz.md) with your notes closed.
