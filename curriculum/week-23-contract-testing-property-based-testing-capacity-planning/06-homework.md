...
When you've finished all six, push your repo and make sure the `marketplace-contracts` [mini-project](./07-mini-project/00-overview.md) is in the same workspace — next week the broker URL, the property tests, and the capacity memo are all capstone deliverables you defend. Then take the [quiz](./05-quiz.md) with your notes closed, and rehearse the capacity memo out loud for the mock interview.
