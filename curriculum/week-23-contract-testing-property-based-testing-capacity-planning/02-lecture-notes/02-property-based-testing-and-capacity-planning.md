...
Next: the exercises put all of this on your capstone — a real Pact consumer/provider pair, property tests against your OR-set merge, and the capacity calculator that produces your memo. Continue to [the exercises](../03-exercises/00-overview.md).
