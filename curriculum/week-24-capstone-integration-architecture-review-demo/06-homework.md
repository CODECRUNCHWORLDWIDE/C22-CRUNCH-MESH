...
This is the last homework of C22. When you've finished all six, you have all six syllabus capstone deliverables. Push the repo, deliver the defense (the [challenge](./04-challenges/challenge-01-deliver-the-capstone-defense-live.md)), and take the [quiz](./05-quiz.md). Then you're done.
