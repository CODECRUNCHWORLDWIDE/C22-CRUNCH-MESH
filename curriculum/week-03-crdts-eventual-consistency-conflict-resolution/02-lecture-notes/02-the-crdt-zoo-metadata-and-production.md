...
Next: the exercises put this in your hands — classify six problems by the right CRDT, implement the zoo and prove convergence, and property-test the semilattice laws. Continue to [the exercises](../03-exercises/00-overview.md).
