...
When you've finished all six, push your repo and make sure the `order-events` [mini-project](./mini-project/README.md) is in the same workspace — Week 11 builds the idempotent consumer on top of it. Then take the [quiz](./quiz.md) with your notes closed.
