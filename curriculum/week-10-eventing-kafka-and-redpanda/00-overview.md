...
| [resources.md](./01-resources.md) | The Kafka docs, Jay Kreps's "The Log," the KIPs, Redpanda docs, and the talks worth your time |
| [lecture-notes/01-the-log-is-the-truth.md](./02-lecture-notes/01-the-log-is-the-truth.md) | The log abstraction, partitions/offsets/keys, consumer groups, the replication protocol, and delivery semantics |
| [lecture-notes/02-redpanda-retention-and-operating-the-cluster.md](./02-lecture-notes/02-redpanda-retention-and-operating-the-cluster.md) | Redpanda's architecture, retention and compaction, Strimzi on Kubernetes, and lag diagnosis |
| [exercises/README.md](./03-exercises/00-overview.md) | Index of the three exercises |
| [exercises/exercise-01-strimzi-on-kind.md](./03-exercises/exercise-01-strimzi-on-kind.md) | Deploy a 3-broker Kafka cluster on Kind via Strimzi, create `order.placed.v1`, and read both endpoints' state |
| [exercises/exercise-02-order-producer.go](./03-exercises/exercise-02-order-producer.go) | An idempotent, keyed Go producer for `order.placed.v1` with proper delivery-report handling |
| [exercises/exercise-03-order-consumer.py](./03-exercises/exercise-03-order-consumer.py) | A Python consumer group with manual commits, rebalance callbacks, and the dual-group fan-out demo |
| [challenges/README.md](./04-challenges/00-overview.md) | Index of the weekly challenge |
| [challenges/challenge-01-diagnose-three-lag-faults.md](./04-challenges/challenge-01-diagnose-three-lag-faults.md) | Detect and prescribe the fix for three different consumer-lag scenarios on a live cluster |
| [quiz.md](./05-quiz.md) | 13 questions with a hidden answer key |
| [homework.md](./06-homework.md) | Six problems including the one-page partitioning-and-retention design memo |
| [mini-project/README.md](./07-mini-project/00-overview.md) | The `order-events` spine: a benchmark harness comparing Kafka and Redpanda on the same producer/consumer code |
