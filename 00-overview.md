...
- [week 01 cap pacelc and flp](./curriculum/week-01-cap-pacelc-and-flp/00-overview.md)
- [week 02 time order and consensus](./curriculum/week-02-time-order-and-consensus/00-overview.md)
- [week 03 crdts eventual consistency conflict resolution](./curriculum/week-03-crdts-eventual-consistency-conflict-resolution/00-overview.md)
- [week 04 microservice fundamentals and decomposition](./curriculum/week-04-microservice-fundamentals-and-decomposition/00-overview.md)
- [week 05 api contracts grpc protobuf](./curriculum/week-05-api-contracts-grpc-protobuf/00-overview.md)
- [week 06 the single hardened service](./curriculum/week-06-the-single-hardened-service/00-overview.md)
- [week 07 service to service bffs gateways envoy](./curriculum/week-07-service-to-service-bffs-gateways-envoy/00-overview.md)
- [week 08 istio in production](./curriculum/week-08-istio-in-production/00-overview.md)
- [week 09 linkerd and cilium service mesh](./curriculum/week-09-linkerd-and-cilium-service-mesh/00-overview.md)
- [week 10 eventing kafka and redpanda](./curriculum/week-10-eventing-kafka-and-redpanda/00-overview.md)
- [week 11 nats jetstream pulsar exactly once](./curriculum/week-11-nats-jetstream-pulsar-exactly-once/00-overview.md)
- [week 12 temporal and workflow orchestration](./curriculum/week-12-temporal-and-workflow-orchestration/00-overview.md)
- [week 13 postgres at scale replication partitioning](./curriculum/week-13-postgres-at-scale-replication-partitioning/00-overview.md)
- [week 14 change data capture cqrs event sourcing](./curriculum/week-14-change-data-capture-cqrs-event-sourcing/00-overview.md)
- [week 15 modern lakehouse iceberg trino olap](./curriculum/week-15-modern-lakehouse-iceberg-trino-olap/00-overview.md)
- [week 16 caching redis memcached dragonfly](./curriculum/week-16-caching-redis-memcached-dragonfly/00-overview.md)
- [week 17 observability opentelemetry prometheus thanos tempo loki](./curriculum/week-17-observability-opentelemetry-prometheus-thanos-tempo-loki/00-overview.md)
- [week 18 reliability sli slo error budgets](./curriculum/week-18-reliability-sli-slo-error-budgets/00-overview.md)
- [week 19 multi region active active active passive](./curriculum/week-19-multi-region-active-active-active-passive/00-overview.md)
- [week 20 crdts in production](./curriculum/week-20-crdts-in-production/00-overview.md)
- [week 21 zero trust networking spiffe spire opa](./curriculum/week-21-zero-trust-networking-spiffe-spire-opa/00-overview.md)
- [week 22 chaos engineering and the gameday](./curriculum/week-22-chaos-engineering-and-the-gameday/00-overview.md)
- [week 23 contract testing property based testing capacity planning](./curriculum/week-23-contract-testing-property-based-testing-capacity-planning/00-overview.md)
- [week 24 capstone integration architecture review demo](./curriculum/week-24-capstone-integration-architecture-review-demo/00-overview.md)
